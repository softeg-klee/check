 ...
 * @endcode
 */
$settings['hash_salt'] = 'BuprGNoX1AQrNVXWhzinMKobhbO4ZCvulgkW-Gw2t-QStvHNY3kINIXqfErckUy-eyDlhWI1dg';
...
if (file_exists($app_root . '/' . $site_path . $settingsFile)) {
  include $app_root . '/' . $site_path . $settingsFile;
}
